...
var Cliente = exports.Cliente = /*#__PURE__*/function () {
  function Cliente(nombre) {
    ...
    _classPrivateFieldSet(_impuesto, this, []);
  }
  _createClass(Cliente, [{
    key: "agregarImpuesto",
    value: function agregarImpuesto(impuesto) {
      _classPrivateFieldGet(_impuesto, this).push(impuesto);
    }
  }, {
    key: "getNombre",
    get: function get() {
    ...
    value: function calcularImpuesto() {
      ...
      _classPrivateFieldGet(_impuesto, this).forEach(function (item) {
        var resultado = (item.getMontoBrutoAnual - item.getDeducciones) * 0.21;
